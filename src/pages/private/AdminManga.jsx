...
const AdminManga = () => {
    ...
    const [selectedManga, setSelectedManga] = useState(null); // NOVO: Estado para gerenciar páginas
    ...
    // NOVO: Renderiza o gerenciador de páginas se um mangá for selecionado
    if (selectedManga) {
            ...
            <ListContainer>
                {mangas.map(manga => (
                    <Item key={manga.id}>
                        ...
                        <ActionButtons>
                            {/* NOVO: Botão para gerenciar páginas */}
                            <button onClick={() => setSelectedManga(manga)}><FaBookOpen /></button>
                            <button onClick={() => handleEdit(manga)}><FaEdit /></button>
                            <button onClick={() => handleDelete(manga.id)}><FaTrash /></button>
                        </ActionButtons>
                    </Item>
                ))}
            </ListContainer>
